...
function printEventData(name, month, day, year, description){
	//get month and year form calendar
	var currentMonthYearDiv = document.getElementById("calendar-month-year");

	//split by space
	var monthYearArr = currentMonthYearDiv.innerHTML.split(" ");

	//month and year variables
	var selectedMonth = monthYearArr[0];
	var selectedYear = monthYearArr[1];

	//only show data for selected month and year
